...
def plot_extended_schedule(df: pd.DataFrame, output_name: str):
    ...
    legend_elements = [
        ...
        Line2D([0], [0], marker='d', color='w', label='Queue Send',
               markerfacecolor='blue', markersize=8),
        Line2D([0], [0], marker='s', color='w', label='Queue Recieve', markerfacecolor='green', markersize=8),
        Line2D([0], [0], marker='^', color='w', label='Task Switched In', markerfacecolor='blue', markersize=8),
        Line2D([0], [0], marker='v', color='w', label='Task Switched Out', markerfacecolor='purple', markersize=8),
